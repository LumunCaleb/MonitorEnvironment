                ...
                if missing_columns:
                    ...
                    if df.isnull().values.any():
                        ...
                        for i in range(len(df)):
                            ...
                            ax.fill_between(x_range, 3, 6, color='orange', alpha=0.3)  # Orange for M level
                            ax.fill_between(x_range, 6, 10, color='green', alpha=0.3)  # Green for S level
